...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'products',     loadComponent: () => import('./pages/home/admin/products/products').then(m => m.ProductsComponent) },
      ...
      { path: 'tickets',      loadComponent: () => import('./pages/home/admin/tickets/tickets').then(m => m.TicketsComponent) },
      { path: 'ticket-list',  loadComponent: () => import('./pages/home/admin/ticket-list/ticket-list').then(m => m.TicketListComponent) },
